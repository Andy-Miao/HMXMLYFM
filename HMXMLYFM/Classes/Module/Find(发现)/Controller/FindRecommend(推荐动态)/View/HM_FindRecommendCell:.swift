...
class HM_FindRecommendCell: UITableViewCell {
    // 创建视图
    // 头像
    ...
    lazy var collectionView : UICollectionView = {
        ...
        collectionView.register(HM_FindRecommendPicCell.self, forCellWithReuseIdentifier:"HM_FindRecommendPicCell")
    ...
    // 数据
    private var findRecommendSteam:HM_FindRStreamList?
    
    var streamModel:HM_FindRStreamList? {
        didSet {
...
// 实现代理
extension HM_FindRecommendCell: UICollectionViewDelegate, UICollectionViewDataSource,UICollectionViewDelegateFlowLayout {
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return self.findRecommendSteam?.picUrls?.count ?? 0
    }
    
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell:HM_FindRecommendPicCell = collectionView.dequeueReusableCell(withReuseIdentifier: "HM_FindRecommendPicCell", for: indexPath) as! HM_FindRecommendPicCell
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        return CGSize.init(width: (SCREEN_WIDTH - 30) / 3, height:(SCREEN_WIDTH - 30) / 3)
    }
