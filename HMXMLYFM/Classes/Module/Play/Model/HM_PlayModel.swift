...
import Foundation
import HandyJSON
struct HM_PlayModel:HandyJSON {
    var ret:Int = 0
    var albumInfo:HM_PlayAlbumInfo?
    var associationAlbumsInfo:[HM_PlayAssociationAlbumsInfo]?
    var noCacheInfo:HM_PlayNoCacheInfo?
    var trackInfo:HM_PlayTrackInfo?
    var userInfo:HM_PlayUserInfo?
}

struct HM_PlayAlbumInfo:HandyJSON {
    var albumId:Int = 0
...
struct HM_PlayAssociationAlbumsInfo:HandyJSON {
    var isDraft:Bool = false
    var albumId:Int = 0
    var uid:Int = 0
    var updatedAt:Int = 0
...
struct HM_PlayNoCacheInfo:HandyJSON {
    var recAlbumsPanelTitle:String?
    var associationAlbumsInfo:[HM_PlayAssociationAlbumsInfo]?
    var communityInfo:HM_PlayCommunityInfo?
    var commentInfo:HM_PlayCommentInfoList?
}
struct HM_PlayCommentInfoList:HandyJSON {
    var list:[HM_PlayCommentInfo]?
}
struct HM_PlayCommentInfo:HandyJSON {
    var createdAt:Int = 0
    var id:Int = 0
    var likes:Int = 0
...
struct HM_PlayCommunityInfo:HandyJSON {
...
struct HM_PlayTrackInfo:HandyJSON {
    var albumId:Int = 0
...
struct HM_PlayUserInfo:HandyJSON {
    var albums:Int = 0
