...
// 播放列表详情页数据模型
struct HM_PlayDetailModel:HandyJSON {
    var album:HM_PlayDetailAlbumModel?
    var user:HM_PlayDetailUserModel?
    var tracks:HM_PlayDetailTracksModel?
...
struct HM_PlayDetailAlbumModel:HandyJSON {
    var albumId:Int = 0
...
struct HM_PlayDetailUserModel:HandyJSON {
    var uid:Int = 0
    var nickname:String?
    var isVerified:Bool = false
...
struct HM_PlayDetailTracksModel:HandyJSON {
    var list:[HM_PlayDetailTracksListModel]?
}

struct HM_PlayDetailTracksListModel:HandyJSON {
    var trackId:Int = 0
    var uid:Int = 0
    var duration:Int = 0
    var albumId:Int = 0
