...
class HM_PlayDetailHeaderView: UIView {
    ...
    func setupView() {
        self.blurImageView = UIImageView.init(frame:  CGRect(x:0 , y:0 , width: SCREEN_WIDTH, height: self.frame.height - 80))
