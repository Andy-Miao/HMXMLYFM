...
import UIKit
// 创建闭包 - OC中的block
typealias HM_HeaderMoreBtnClick = () -> Void

class HM_RecommendHeaderView: UICollectionReusableView {
    
    var headerMoreBtnClick : HM_HeaderMoreBtnClick?
    ...
    var homeRecommendList:HM_RecommendModel? {
        didSet{
