...
let HM_ClassifySubMenuProvider = MoyaProvider<HM_ClassifySubMenuAPI>()

// 请求分类
public enum HM_ClassifySubMenuAPI {
    // 顶部分类传参categoryId
...
// 请求配置
extension HM_ClassifySubMenuAPI: TargetType {
