...
let HM_HomeClassifyProvider = MoyaProvider<HM_HomeClassifyAPI>()

// 请求分类
public enum HM_HomeClassifyAPI {
    case classifyList
}

// 请求配置
extension HM_HomeClassifyAPI: TargetType {
