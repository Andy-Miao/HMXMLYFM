...
// 最外层的model
struct HM_HomeRecommendModel: HandyJSON {
    var msg:String?
    var ret:Int = 0
    var code:String?
    var list:[HM_RecommendModel]?
}
...
struct HM_RecommendModel: HandyJSON {
    ...
    var target: HM_Target?
    var recWords: [HM_RecWords]?
    
    var categoryId: Int = 0
    var direction: String?
    var keywords: [HM_Keywords]?
    
}
struct HM_RecommendListModel: HandyJSON {
    var albumId: Int = 0
    var categoryId: Int = 0
...
struct HM_Target: HandyJSON{
    var groupId: Int = 0
    var categoryId: Int = 0
}
struct HM_RecWords: HandyJSON{
    var contentType: String?
    var properties:HM_Properties?
    var title: String?
}
struct HM_Properties: HandyJSON {
    var isPaid: Bool = false
    var type: String?
    var uri: String?
    var albumId: Int = 0
}
struct HM_Keywords: HandyJSON {
    var categoryId: Int = 0
...
struct HM_FocusModel: HandyJSON {
    var data: [HM_BannerData]?
    var responseId: Int = 0
    var ret : Int = 0
}

struct HM_BannerData: HandyJSON {
    var adId: Int = 0
    var adType: Int = 0
...
struct HM_SquareModel: HandyJSON {
...
struct HM_TopBuzzModel: HandyJSON {
    var albumId: Int = 0
...
struct HM_GuessYouLikeModel: HandyJSON {
    var albumId: Int = 0
    var categoryId: Int = 0
    var commentsCount: Int = 0
    var infoType: String?
...
struct HM_PaidCategoryModel: HandyJSON {
    var albumId: Int = 0
    var categoryId: Int = 0
    var commentsCount: Int = 0
    var commentScore: CGFloat = 0.0
...
struct HM_PlaylistModel: HandyJSON {
...
struct HM_OneKeyListenModel: HandyJSON {
    var channelId: Int = 0
    var channelName: String?
    var cover: String?
    var coverRound: String?
    var onLineNum: Int = 0
    var recInfo: HM_RecInfo?
}

struct HM_RecInfo: HandyJSON {
    var recSrc: String?
    var recTrack: String?
}

struct HM_LiveModel: HandyJSON {
...
struct HM_AdvertShareData: HandyJSON {
    var linkUrl: String?
